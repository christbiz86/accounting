...
if (isset($_POST['Process']))
{
	...
	#$cart->memo_ = $_POST['memo_'];
        if($_POST['PayType']=='Miscellaneous'){
            $person_id = $_POST['person_id_miscell'];
        } else if($_POST['PayType']=='Supplier'){
            $person_id = $_POST['person_id_sup'];
        } else if($_POST['PayType']=='Customer'){
            $person_id = $_POST['person_id_cust'];
        }
	$cart->memo_ = $_POST['PayType'].' - '.$person_id;
...
function check_item_data()
{
        ...
        {
                display_error(_("Dimension 1 tidak boleh kosong"));
                set_focus('dimension_id');
                return false;
        }

        if(empty($_POST['dimension2_id']))
        {
                display_error(_("Dimension 2 tidak boleh kosong"));
