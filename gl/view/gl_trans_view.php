...
function display_gl_heading($myrow)
{
    ...
    echo "<p style=\"color:red;font-weight:bold;font-size:20px\">JOURNAL VOUCHER</p><p style=\"font-weight:bold;font-size:20px\">".substr(get_dimension_string($myrow['dimension_id']),7)."</p>";
...
echo "<table border=1 style=\"margin:auto;\">
    <tr>
        <td width=\"200\" style=\"font-weight:bold\" align=\"center\">Diajukan</td>
        <td width=\"200\" style=\"font-weight:bold\" align=\"center\">Diperiksa</td>
        <td width=\"200\" style=\"font-weight:bold\" align=\"center\">Disetujui</td>
    </tr>
    <tr>
        <td><br><br><br></td>
        <td><br><br><br></td>
